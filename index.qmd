...
- Define common data specification for community-level data
  - FAIR, TRUST
  - privacy, equitable disaggregation
- Provide a method and tools for harmonizing, storing, accessing, and **sharing** community-level data
  - spatiotemporal harmonization and interpolation tools
  - checks to contribute aggregate, community-level data
  - API for accessing data at scale and on demand
- Provide an interactive data catalog
  - 'portable' data catalog derived on demand from metadata
  - open API to serve as foundation for other data catalogs (e.g., C2D2)
- Interactive web application
  - explore distributions across Cincinnati
  - exploring simple relationships between community-level measures
...
- curate and serve data, metadata, visualizations all in one language
